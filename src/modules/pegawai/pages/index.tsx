...
/** Type Imports */
import { TListEmployee, TPayloadCreate, TPayloadUpdate } from '../types'

const DEFAULT_VALUE_ROW: TListEmployee = {
  uuid: '',
  name: '',
  salary: 0,
  work_placement: {
...
const Page = () => {
  ...
  const [selectedRow, setSelectedRow] = useState<TListEmployee>(DEFAULT_VALUE_ROW)
  ...
  const handleOpenEdit = useCallback((row: TListEmployee) => {
    setSelectedRow(row)
